# ============================================================
# AI SMART BUS
# FULL-FRAME GARBAGE DETECTION
#
# Features:
# - Detect garbage anywhere in the camera frame
# - Green bounding box
...
# Lower threshold helps detect weaker garbage predictions.
...
def main():
    ...
    print(
        "📊 Detection    : FULL CAMERA"
    )

    print(
        "📱 Aspect       : 19.5:9 supported"
    )
    ...
    while not stop_event.is_set():
        ...
        cv2.imshow(
            ...
            "AI Smart Bus - Full Frame Garbage Detection",
